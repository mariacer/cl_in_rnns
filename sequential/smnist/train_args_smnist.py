...
#
# @title          :sequential/smnist/train_args_smnist.py
# @author         :mc
...
"""
Command-line arguments and default values for the SMNIST task are handled here.
"""
import argparse
import warnings
...
def parse_cmd_arguments(mode='split_smnist', default=False, argv=None):
    ...
    rep_args.add_argument('--distill_across_time', action='store_true',
