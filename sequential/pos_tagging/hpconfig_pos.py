...
#
# @title          :sequential/pos_tagging/hpconfig_pos.py
# @author         :ch, mc, be
...
"""
Configuration file for the hyperparameter search of the PoS tagging experiments
...
def _performance_criteria(summary_dict, performance_criteria):
    ...
    """
    performance = float(summary_dict['mean_final_fscore'][0])
...
_PERFORMANCE_KEY = 'mean_final_fscore'
...
# ...                                             argv=argv)
# >>> _ARGPARSE_HANDLE = f
from sequential.pos_tagging import train_args_pos as targs
