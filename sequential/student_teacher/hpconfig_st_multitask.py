...
#
# @title          :sequential/student_teacher/hpconfig_st_multitask.py
# @author         :ch
...
"""
Configuration file for the hyperparameter search of the Student-Teacher
experiments in multitask setting.
"""
...
grid = {
    ...
    #'orth_teacher_hid_mat': [False],
    #'rank_teacher_hid_mat': [-1],
    #'max_sv_teacher_hid_mat': [-1],
    #'num_timesteps_in': [10],
    #'num_timesteps_out': [-1],
}
...
def _performance_criteria(summary_dict, performance_criteria):
    ...
    """
    performance = float(summary_dict['mean_final_loss'][0])
...
_PERFORMANCE_KEY = 'mean_final_loss'
...
# ...                                             argv=argv)
# >>> _ARGPARSE_HANDLE = f
from sequential.student_teacher import train_args_st as targs
