...
class RndRecTeacher(SequentialDataset):
    ...
    Attributes:
        mat_A (numpy.ndarray): The teacher matrix :math:`A^{(k)}`.
        mat_B (numpy.ndarray): The teacher matrix :math:`B^{(k)}`.
        mat_C (numpy.ndarray): The teacher matrix :math:`C^{(k)}`.
    ...
    @property
    def mat_A(self):
        """Getter for read-only attribute :attr:`mat_A`."""
        return self._mat_A

    @property
    def mat_B(self):
        """Getter for read-only attribute :attr:`mat_B`."""
        return self._mat_B

    @property
    def mat_C(self):
        """Getter for read-only attribute :attr:`mat_C`."""
        return self._mat_C
