...
.. autosummary::
    ...
    utils.si_regularizer.si_pre_optim_step
    utils.si_regularizer.si_post_optim_step
    utils.si_regularizer.si_compute_importance
    utils.si_regularizer.si_regularizer
"""
