...
weights), one would have to provide two distinct implementations:
...
class HyperNetwork(nn.Module, CLHyperNetInterface):
    ...
    .. deprecated:: 1.0
        Please use class :class:`hnets.mlp_hnet.HMLP` instead.
    ...
    def __init__(self, target_shapes, num_tasks, layers=[50, 100], verbose=True,
                 ...
                 random_scale_feedback_matrix=1., use_batch_norm=False,
                 noise_dim=-1, temb_std=-1):
        ...
        Args:
            ...
            no_te_embs: If this option is ``True``, no class internal task
                ...
                provided to the :meth:`forward` method.
        ...
        warn('Please use class "hnets.mlp_hnet.HMLP" instead.',
             DeprecationWarning)
